              ...
              <div class="item grid-sizer col-md-6 col-lg-4 video application">
                <div class="box bg-white shadow p-30">
                  <figure class="main overlay overlay2 rounded mb-30">
                    <a href="{{ asset('storage/'.$portfolio->cover) }}1" class="lightbox"> <img src="{{ asset('storage/'.$portfolio->cover) }}" alt="" /></a></figure>
                  <div class="Dishes-content">
                    <h2 class="Dishes-title mb-10"><a href="{{ asset('storage/'.$portfolio->cover) }}">{{ $portfolio->name }}</a></h2>
                    <div class="meta mb-0">
                      <i class="fa fa-home"></i> Restaurant "{{ $portfolio->client }}"
                    </div>
                    <div class="meta mb-0">
                      <i class="fa fa-cutlery"></i> {{ $portfolio->pcategory->name }}
                    </div>
